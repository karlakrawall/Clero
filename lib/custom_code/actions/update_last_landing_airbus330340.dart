...
Future<void> updateLastLandingAirbus330340(String lastLandingMonth) async {
  ...
  // Format date as a string (if storing as a string)
  String formattedRecencyEnd =
      DateFormat('MMMM dd, yyyy').format(recencyEndDate);
  ...
  await userDoc.update({
    'recency_Airbus330340': formattedRecencyEnd, // Stores as a formatted string
  });
}
