...
Future<int> queryDeadlinesRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      DeadlinesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DeadlinesRecord>> queryDeadlinesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      DeadlinesRecord.collection,
      DeadlinesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DeadlinesRecord>> queryDeadlinesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
